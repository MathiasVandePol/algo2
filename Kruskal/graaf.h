...
public:
    ...
    friend  std::ostream& operator<<(std::ostream& os, const Verbinding<Takdata>& v) {
        os << "Van: " << v.van << ", Naar: " << v.naar << ", Gewicht: " << v.gewicht;
        return os;
    }
};
...
public:
    ...
    std::priority_queue< Verbinding<Takdata>, vector<Verbinding<Takdata> >, CompVerbinding<Takdata> > alle_verbindingen;    //gesorteerd van klein naar groot
